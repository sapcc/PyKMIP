    ...
    def execute_mysql_queries(self, kmip_id, operation_policy_name=None, owner=None):
        ...
        try:
            ...
            with conn.cursor(dictionary=True) as cursor:
                ...
                # Optional: Execute UPDATE Query
                if operation_policy_name or owner:
                    update_query = None
                    update_values = None
                ...
                return {
                    ...
                    "kmip_details": result,
                    "query_executed": update_query if operation_policy_name or owner else None,
                    "query_values": update_values if operation_policy_name or owner else None,
                }
